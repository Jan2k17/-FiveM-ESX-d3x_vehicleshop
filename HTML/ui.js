...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Marke: <b>`+car.categoryLabel+`</b></p>
                                        <p class="card-text">Preis: <b>`+car.price+`€</b></p>
                                        <p class="card-text">Lager: <b>`+car.storage+`</b></p>
                                    </div>
    ...
    window.addEventListener('message', function(event) {
        ...
        $('#brand').html(`<option selected value="-1">Alle Marken</option>`)
